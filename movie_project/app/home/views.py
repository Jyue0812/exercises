...
from app.models import User, Userlog, db, Preview, Tag, Movie
from werkzeug.security import generate_password_hash
from app.home.forms import RegistForm, UserdetailForm, LoginForm, PwdForm
from . import home
...
def change_filename(filename):
    ...
    filename = datetime.datetime.now().strftime("%Y%m%d%H%M%S") + str(uuid4().hex) + fileinfo[-1]
    return filename
